module github.com/msft-latam-devsquad/lambda-to-azure-converter/go-examples
...
require (
	github.com/MicahParks/go-aws-sam-lambda-example v0.0.0-20220116021921-406d2ef6f9c2
